...
Welcome to KupaPay. These Terms of Service ("Terms") are a binding agreement between you and **sarussilberg**, operating from Israel ("KupaPay", "we", "us"). They govern your use of the KupaPay mobile application and any related services (collectively, the "Service").
...
ברוכים הבאים ל-KupaPay. תנאי שירות אלה ("התנאים") הם הסכם מחייב בינך לבין **sarussilberg**, עוסק יחיד הפועל מישראל ("KupaPay", "אנחנו", "אנו"), ומסדירים את השימוש שלך באפליקציית המובייל של KupaPay ובכל השירותים הקשורים אליה (להלן יחד: "השירות").
...
מדיניות פרטיות זו מסבירה כיצד **sarussilberg** ("KupaPay", "אנחנו", "אנו"), עוסק יחיד הפועל מישראל, אוספת, משתמשת וחושפת מידע במסגרת השימוש שלך באפליקציית המובייל של KupaPay ובשירותים הקשורים אליה ("השירות"). לשאלות: **sarussilberg@gmail.com**.
